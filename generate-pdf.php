...
$content .= '
    ...
    <div class="intro"> 
        <img src="https://volvoceblog.com/calculators/images/exportlogo.jpg" alt="" width="700" />
        <p>Report Generated on: July 2, 2021</p>
        <img src="https://volvoceblog.com/calculators/images/exportheader.jpg" alt=""  width="700" />
        <p style="margin-top: 30px;">This report breaks down all of the financial details based on your input. It makes a 
        great reference as you evaluate purchasing the equipment that will meet your needs. Remember this report provides 
        estimates, but you’ll need to make the actual payments based on your specific finance and dealer terms.</p>
    </div>
    ...
    <p class="small color-gray" style="margin-top: 40px;">This quote provides an estimated payment. Your actual payment 
    may vary depending on finance and dealer terms. Lease payments and purchase options are subject to taxes (GST/PST/HST).
     All amounts are displayed in USD. Taxes and miscellaneous fees are not included. There is no commitment on the part 
     of Volvo Construction Equipment to make any loan or lease to the user.</p>

<img src="https://volvoceblog.com/calculators/images/exportfooter.jpg" alt=""  width="700" />
